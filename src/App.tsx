...
const Partners = () => {
  const partners = [
    ...
    { name: "EMTU", logo: "https://upload.wikimedia.org/wikipedia/commons/7/72/EMTU_-_Symbol_logo.png" },
    { name: "VLT Carioca", logo: "https://images.seeklogo.com/logo-png/33/1/vlt-carioca-logo-png_seeklogo-331136.png" },
